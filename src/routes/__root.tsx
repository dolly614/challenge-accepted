...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Uyanix Uyanix 30 Days Challenge" },
      ...
      { property: "og:title", content: "Uyanix Uyanix 30 Days Challenge" },
      ...
      { name: "twitter:title", content: "Uyanix Uyanix 30 Days Challenge" },
